...
class AuthController extends Controller
{
    ...
    public function postlogin(Request $request)
    {
    	if(Auth::attempt($request->only('username','password'))){
            ...
            }elseif($akun->role =='Bagiankeuangan'){
                Auth::guard('bagiankeuangan')->LoginUsingId($akun->id);
               
                return redirect('/bagiankeuangans');
            }
    	}
    ...
    public function logout()
    {
        ...
        } else if(Auth::guard('bagiankeuangan')->check()){
            Auth::guard('bagiankeuangan')->logout();
        }
