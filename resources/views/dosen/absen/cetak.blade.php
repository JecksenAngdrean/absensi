        ...
        <table class="tg table">
          ...
          @forelse ($items as $index => $item)
            <tr>
              ...
              <td class="tg-3xi5">{{number_format((($item->p1 + $item->p2 + $item->p3 + $item->p4 + $item->p5 + $item->p6 + $item->p7 + $item->p8 + $item->p9 + $item->p10 + $item->p11 + $item->p12 + $item->p13 + $item->p14 + $item->p15 + $item->p16) / 16) * 100 , 2)}}%</td>
            </tr>
            @empty
            <tr>
              <td>
