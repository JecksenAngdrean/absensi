...
<div id="absen">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <a href="{{ url('datadosen') }}/{{$schedule->dosen->id}}?bulan={{ date('Y-m') }}" class="btn btn-primary pull-left mb-3">
    ...
    <div class="row">
      <div class="col-12">
        <a href="{{ url('datadosen') }}/{{$schedule->dosen->id}}/{{$schedule->id}}/cetak" target="_blank" class="btn btn-success mt-3 mb-3">Cetak Absen <i class="fas fa-print"></i></a>
