                ...
                <div class="card-body">
                  ...
                  @csrf
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Tanggal Awal Pertemuan</label>
                          <input type="date" class="form-control" name="tanggal_awal_pertemuan" value="{{ old('tanggal_awal_pertemuan') ? old('tanggal_awal_pertemuan') : $item->tanggal_awal_pertemuan }}" 
                            class="form-control @error('tanggal_awal_pertemuan') is-invalid @enderror">
                            @error('tanggal_awal_pertemuan') <div class="text-muted">{{ $message }}</div> @enderror
                        </div>
                      </div>
                    </div>
