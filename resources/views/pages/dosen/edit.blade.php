                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control @error('id_prodi') is-invalid @enderror" id="exampleFormControlSelect1" name="id_fakultas">
                            @foreach ($prodi as $itemF)
                              @if ($item->id_prodi == $itemF->id)
                                <option value="{{ $itemF->id }}" selected>{{ $itemF->prodi }}</option>
                              @else
                                <option value="{{ $itemF->id }}">{{ $itemF->prodi }}</option>
                              @endif
                            @endforeach
                          </select>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Honor Per Jam</label>
                          <input type="number" class="form-control" name="honor" value="{{ old('honor') ? old('honor') : $item->honor }}" 
                            class="form-control @error('honor') is-invalid @enderror">
                            @error('honor') <div class="text-muted">{{ $message }}</div> @enderror
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select name="agama" class="form-control @error('agama') is-invalid @enderror">
                          ...
                          <option value="Islam" {{ (old('agama') ? old('agama') : $item->agama) == 'Islam' ? 'selected' : '' }}>Islam</option>
                          <option value="Kristen Protestan" {{ (old('agama') ? old('agama') : $item->agama) == 'Kristen Protestan' ? 'selected' : '' }}>Kristen Protestan</option>
                          <option value="Katolik" {{ (old('agama') ? old('agama') : $item->agama) == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                          <option value="Hindu" {{ (old('agama') ? old('agama') : $item->agama) == 'Hindu' ? 'selected' : '' }}>Hindu</option>
                          <option value="Buddha" {{ (old('agama') ? old('agama') : $item->agama) == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                          <option value="Khonghucu" {{ (old('agama') ? old('agama') : $item->agama) == 'Khonghucu' ? 'selected' : '' }}>Khonghucu</option>
                        </select>
